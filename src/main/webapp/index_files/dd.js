(function () {
    ...
    function t() {
        var e = 0, a = new Y(m), n = document.createTextNode("");
        return a.observe(n, {characterData: !0}), function () {
            n.data = e = ++e % 2
        }
    }
    ...
    function l() {
        try {
            var e = require, a = e("vertx");
            return R = a.runOnLoop || a.runOnContext, s()
        } catch (n) {
            return c()
        }
    }
    ...
    function g(e, a, n) {
        H(function (e) {
            var i = !1, o = v(n, a, function (n) {
                i || (i = !0, a !== n ? w(e, n) : z(e, n))
            }, function (a) {
                i || (i = !0, I(e, a))
    ...
    function h(e, a) {
        a._state === $ ? z(e, a._result) : a._state === ee ? I(e, a._result) : C(a, void 0, function (a) {
            w(e, a)
        }, function (a) {
            I(e, a)
        })
    ...
    function y(e, n) {
        if (n.constructor === e.constructor)h(e, n); else {
            var i = b(n);
            i === ae ? I(e, ae.error) : void 0 === i ? z(e, n) : a(i) ? g(e, n, i) : z(e, n)
        }
    }

    function w(a, n) {
        a === n ? I(a, u()) : e(n) ? y(a, n) : z(a, n)
    }
    ...
    function z(e, a) {
        e._state === X && (e._result = a, e._state = $, 0 !== e._subscribers.length && H(P, e))
    }

    function I(e, a) {
        e._state === X && (e._state = ee, e._result = a, H(_, e))
    }

    function C(e, a, n, i) {
        var o = e._subscribers, r = o.length;
        e._onerror = null, o[r] = a, o[r + $] = n, o[r + ee] = i, 0 === r && e._state && H(P, e)
    }

    function P(e) {
        var a = e._subscribers, n = e._state;
        if (0 !== a.length) {
            for (var i, o, r = e._result, s = 0; s < a.length; s += 3)i = a[s], o = a[s + n], i ? A(n, i, o, r) : o(r);
    ...
    function A(e, n, i, o) {
        var r, s, t, d, c = a(i);
        if (c) {
            if (r = k(i, o), r === ne ? (d = !0, s = r.error, r = null) : t = !0, n === r)return void I(n, f())
        } else r = o, t = !0;
        n._state !== X || (c && t ? w(n, r) : d ? I(n, s) : e === $ ? z(n, r) : e === ee && I(n, r))
    }
    ...
    function T(e, a) {
        var n = this;
        n._instanceConstructor = e, n.promise = new e(p), n._validateInput(a) ? (n._input = a, n.length = a.length, n._remaining = a.length, n._init(), 0 === n.length ? z(n.promise, n._result) : (n.length = n.length || 0, n._enumerate(), 0 === n._remaining && z(n.promise, n._result))) : I(n.promise, n._validationError())
    }
    ...
    function j(e) {
        ...
        var i = this, o = new i(p);
        if (!q(e))return I(o, new TypeError("You must pass an array to race.")), o;
        for (var r = e.length, s = 0; o._state === X && r > s; s++)C(i.resolve(e[s]), void 0, a, n);
        return o
    }
    ...
    function L(e) {
        this._id = de++, this._state = void 0, this._result = void 0, this._subscribers = [], p !== e && (a(e) || W(), this instanceof L || J(), x(this, e))
    }
    ...
    var R, N, V, q = O, F = 0, H = ({}.toString, function (e, a) {
        Q[F] = e, Q[F + 1] = a, F += 2, 2 === F && (N ? N(m) : V())
    }), U = "undefined" != typeof window ? window : void 0, G = U || {}, Y = G.MutationObserver || G.WebKitMutationObserver, Z = "undefined" != typeof process && "[object process]" === {}.toString.call(process), K = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, Q = new Array(1e3);
    V = Z ? r() : Y ? t() : K ? d() : void 0 === U && "function" == typeof require ? l() : c();
    var X = void 0, $ = 1, ee = 2, ae = new S, ne = new S;
    T.prototype._validateInput = function (e) {
        return q(e)
    ...
    T.prototype._enumerate = function () {
        for (var e = this, a = e.length, n = e.promise, i = e._input, o = 0; n._state === X && a > o; o++)e._eachEntry(i[o], o)
    }, T.prototype._eachEntry = function (e, a) {
        var i = this, o = i._instanceConstructor;
        n(e) ? e.constructor === o && e._state !== X ? (e._onerror = null, i._settledAt(e._state, a, e._result)) : i._willSettleAt(o.resolve(e), a) : (i._remaining--, i._result[a] = e)
    }, T.prototype._settledAt = function (e, a, n) {
        var i = this, o = i.promise;
        o._state === X && (i._remaining--, e === ee ? I(o, n) : i._result[a] = n), 0 === i._remaining && z(o, i._result)
    }, T.prototype._willSettleAt = function (e, a) {
        var n = this;
    ...
    var oe = B, re = j, se = E, te = M, de = 0, ce = L;
    L.all = oe, L.race = re, L.resolve = se, L.reject = te, L._setScheduler = i, L._setAsap = o, L._asap = H, L.prototype = {
        constructor: L,
        then: function (e, a) {
            var n = this, i = n._state;
            if (i === $ && !e || i === ee && !a)return this;
            var o = new this.constructor(p), r = n._result;
            if (i) {
                var s = arguments[i - 1];
                H(function () {
                    A(i, o, s, r)
    ...
    var me = D, le = {Promise: ce, polyfill: me};
    "function" == typeof define && define.amd ? define(function () {
        return le
    }) : "undefined" != typeof module && module.exports ? module.exports = le : "undefined" != typeof this && (this.ES6Promise = le), me()
}).call(this), function () {
    "use strict";
    var e = {}, a = navigator.userAgent, n = a.match(/AliApp\(\w+\/([a-zA-Z0-9.-]+)\)/);
    ...
    var a = "1.6.7", n = {
        ...
        biz: [{
            ...
            namespace: "biz.util.ut", name: "上报埋点", ios: "2.4.0", android: "2.4.0", paramsCallback: function (a) {
                var n = a.value, i = [];
                if (n && "Object" == e.type(n))if (e.ios)n = JSON.stringify(n); else if (e.android) {
            ...
            ios: "2.4.0",
            android: "2.4.0"
        }, {namespace: "biz.util.qrcode", name: "弹窗alert", ios: "2.4.0", android: "2.4.0"}, {
            ...
            release: !1,
            paramsCallback: function (e) {
                var a = e.logName || "h5_common_error", n = "url=" + location.href, i = [], o = e.obj || {};
                for (var r in o)i.push(r + "=" + o[r]);
                e.message = {msg: a + " " + n + " " + i.join(" ")}
            }
        }, {
            ...
            android: "3.5.2",
            release: !1
        }, {namespace: "biz.util.selectEmoji", name: "选择表情", ios: "3.5.2", android: "3.5.2", release: !1}],
        ui: [{
        ...
        internal: [{
            ...
            name: "调用选会话组件并发送@人文字消息", ios: "3.4.6", android: "3.4.6", release: !1, defaultParams: {}
        }, {
    ...
    e.extend(e, {sdk_version: a}), e.extend(e, {methods: n})
}(__dd), function (e, a) {
    "use strict";
    function n(a, n, i) {
        ...
        o.onSuccess && (r = o.onSuccess, delete o.onSuccess), o.onFail && (s = o.onFail, delete o.onFail), o.onCancel && (t = o.onCancel, delete o.onCancel);
        var d = function (e) {
            var a = e || {}, n = a.errorCode, i = a.result;
            "0" === n ? r && r.call(null, i) : "-1" === n ? t && t.call(null, i) : s && s.call(null, i, n)
        }, c = o.watch;
        if (e.android) {
            var m = a.split("."), l = m.pop(), p = m.join(".");
            window.WebViewJavascriptBridgeAndroid && WebViewJavascriptBridgeAndroid(r, s, p, l, o)
        } else e.ios && (c ? (window.WebViewJavascriptBridge && WebViewJavascriptBridge.registerHandler(a, function (e, a) {
            d({errorCode: "0", errorMessage: "成功", result: e}), a && a({errorCode: "0", errorMessage: "成功"})
        }), window.WebViewJavascriptBridge && WebViewJavascriptBridge.callHandler(a, o)) : window.WebViewJavascriptBridge && WebViewJavascriptBridge.callHandler(a, o, d))
    }

    var i, o = !1, r = null, s = "runtime.permission.requestJsApis", t = null, d = !1, c = !1, m = !1;
    window.ES6Promise ? (ES6Promise.polyfill(), c = !0) : window.Promise || (window.Promise = function () {
    });
    e.extend(e, {
        ability: "", config: function (a) {
            a && (r = {
                corpId: a.corpId,
                appId: a.appId || -1,
                ...
                type: a.type || -1
            }, e.cfg = r, a.agentId && (r.agentId = a.agentId))
        }, error: function (e) {
            t = e
        }, ready: function (n) {
            var i = this, c = function (a) {
                if (!a)return console.log("bridge初始化失败");
                if (null === r)m || (console.log("没有配置dd.config"), m = !0), n(a); else if (e.ios)a.callHandler(s, r, function (e) {
                    var i = e || {}, o = i.errorCode, r = i.errorMessage || "";
                    i.result;
                    "0" === o ? n(a) : setTimeout(function () {
                        t && t({message: "权限校验失败 " + r, errorCode: 3})
                    })
                }); else if (e.android) {
                    var d = s.split("."), c = d.pop(), l = d.join(".");
                    a(function () {
                        n(a)
                    }, function (e) {
                        setTimeout(function () {
                            var a = e && e.errorMessage || "";
                            t && t({message: "权限校验失败 " + a, errorCode: 3})
                        })
                    }, l, c, r)
                }
                if (o === !1 && (o = !0, e.events.forEach(function (n) {
                    ...
                    e.biz.util.ut({
                        key: "dd_open_js_monitor", value: JSON.stringify(p), onSuccess: function (e) {
                        }
                    }), location.href.indexOf("dingtalk.com") > -1 && (e.internal.log.add({text: "dd.ready"}), e.ios && i.compareVersion(e.version, "3.5.0") && (console.log("dd.js runtime.monitor.usability"), e.runtime.monitor.usability()))
                }
            };
            ...
            if (e.ios)document.addEventListener("WebViewJavascriptBridgeReady", function () {
                ...
                d = !0, c(WebViewJavascriptBridge)
            }, !1); else {
                if (!e.android)return console.log("请在钉钉App打开此页面");
                var p = function () {
                    try {
                        a.WebViewJavascriptBridgeAndroid = a.nuva.require(), d = !0, c(WebViewJavascriptBridgeAndroid)
                    } catch (e) {
                        console.log("window.nuva.require出错", e.message), c(null)
                    }
                };
            ...
            for (var i, o, r = e.split("."), s = a.split("."); i === o && s.length > 0;)i = r.shift(), o = s.shift();
            return n ? (0 | o) >= (0 | i) : (0 | o) > (0 | i)
        }
    });
    var l = function (a, n) {
        for (var i = a.split("."), o = e, r = 0, s = i.length; s > r; r++)r === s - 1 && (o[i[r]] = n), "undefined" == typeof o[i[r]] && (o[i[r]] = {}), o = o[i[r]]
    }, p = function (a, o, r) {
        return c ? new Promise(function (s, t) {
            o = o || {}, o._onSuccess = o.onSuccess || function () {
                }, o._onFail = o.onFail || function () {
                }, o._onCancel = o.onCancel || function () {
                }, o.onSuccess = function () {
                o._onSuccess.apply(this, arguments), s.apply(this, arguments)
            }, o.onFail = function () {
                o._onFail.apply(this, arguments), t.apply(this, arguments)
            }, o.onCancel = function () {
                o._onCancel.apply(this, arguments), t.apply(this, arguments)
            }, i = new Promise(function (a, n) {
                e.ready(function (e) {
                    a(e)
                })
            }), Promise.all([i]).then(function (i) {
                o = o || {}, e.cfg && e.cfg.corpId && (o.corpId = e.cfg.corpId), n(a, o, r)
            })
        }) : (o = o || {}, e.cfg && e.cfg.corpId && (o.corpId = e.cfg.corpId), n(a, o, r), void 0)
    };
    ...
    e._invoke = function (e) {
        ...
        var n = "open_micro_log_record_client", i = +new Date, o = a.corpId, s = a.agentId;
        o || (o = r && r.corpId || ""), s || (s = r && r.agentId || "");
        var t = {
            visitTime: i,
            clickType: 2,
        ...
        return e.biz.util.ut({key: n, value: t}), c ? new Promise(function (e) {
            e()
        }) : void 0
    }
}(__dd, window), function (e, a) {
    "use strict";
    if (!a.IDLAPI) {
        var n = {};
        a.LWP_DEBUG;
        n.__modules = {}, n.interfaces = {}, n.__send = function () {
            var n, i = Array.prototype.slice.apply(arguments, []), o = i[0].uri, r = i[0].data || [], s = i[0].success, t = i[0].error, d = i[0].dataType || "json";
            return new Promise(function (c, m) {
                a.LWP_PROXY === !0 ? (a.Zepto ? n = Zepto.ajax : a.jQuery && (n = jQuery.ajax), n && n({
                    url: i[0].debugUrl,
                    data: r,
                    type: "GET",
                    dataType: "json",
                ...
                })) : e.internal.request.lwp({
                    uri: o,
                    body: r,
                    headers: {referer: a.location.href},
                    onSuccess: function (a) {
                        if ("json" == d)if ("string" != typeof a || "{" != a.substring(0, 1) && "[" != a.substring(0, 1) || (a = JSON.parse(a)), a && 200 == a.statusCode) {
                            var n = a.responseText, i = {};
                            n && (i = "{" == n.substring(0, 1) || "[" == n.substring(0, 1) ? JSON.parse(n) : n), s && s(i), c(i)
                        } else if (a.responseText) {
                            var n = a.responseText, i = {};
                            i = "{" == n.substring(0, 1) || "[" == n.substring(0, 1) ? JSON.parse(n) : n, t && t({
                                statusCode: i.code,
                                statusText: i.reason,
                                responseText: i.reason
                            }), m({statusCode: i.code, statusText: i.reason, responseText: i.reason});
                            var l = [];
                            l.push("errorType:lwp"), l.push("target_url:" + location.href), l.push("uri:" + o), l.push("params:" + r.join(",")), l.push("reponseText:" + JSON.stringify(i)), e.biz.util.warn({message: l.join(" ")})
                        } else a && a.statusText && (a.responseText = a.statusText), t && t(a), m(a), e.biz.util.warn({
                            logName: "h5_lwp_error",
                            obj: {uri: o, params: r.join(","), reponseText: JSON.stringify(a)}
                        }); else s && s(a), c(a)
                    },
                    onFail: function (a) {
                        a = a || {}, t && t(a), m(a), e.biz.util.warn({
                            logName: "h5_lwp_error",
                            obj: {uri: o, params: r.join(","), reponseText: JSON.stringify(a)}
                        })
                    }
        ...
        var i = function (e, a, i) {
            n.interfaces[i.moduleName] = a()
        };
        n.module = function (e) {
            return n.__modules[e] ? n.__modules[e] = n.__modules[e]++ : n.__modules[e] = 1, {
...
}(dd, window), function (e) {
    "use strict";
    var a = (location.host.indexOf(".dingtalk.com") > -1 ? !0 : !1, {
        init: function () {
            e.internal.hpm.update({force: !0})
        }, update: function () {
        }
    });
    e.extend(e, {hpm: a})
