(function (config) {
    ...
    var Zb = window.AMap.TC = {}, mc = config[2].split(",")[0], nc = mc + "/theme/v" + config[4] + "/style1503546983737.css", oc = document.head || document.getElementsByTagName("head")[0];
    if (oc) {
    ...
    function rc() {
        for (var a = mc + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.AN.join(",") + "&vrs=1503546983737", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1)if (0 === b[d].src.indexOf(mc.split(":")[1] + "/maps?")) {
            c = b[d];
            break
        }
    ...
    try {
        if (window.localStorage) {
            var tc = window.localStorage["_AMap_" + config.Fd], uc = !1;
...
})(["3ce6b14e9be47fac6eed9a02033d2cd5", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "https://webapi.amap.com", 1, "1.3", null, "110000", "", true, true, true, true, "1504099526-1"])