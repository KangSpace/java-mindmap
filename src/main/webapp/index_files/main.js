(function () {
    var V = V || {Aa: {Jc: 0, Wk: []}}, wc = {};
    V.CLASS_NAME = "AMap";
    V.a = V.BuryPoint = {tL: {}, vB: {}, options: {}, MB: {}, nG: {}, oG: {}, ZG: {}, $G: {}};
    ...
    V.a.lZ = V.BuryPoint.getMethodName = function (a, b) {
        var c;
    ...
    V.a.Za = V.BuryPoint.addOptions = function (a, b) {
        var c = this.lg[a].c, d, f;
        for (f in b)b.hasOwnProperty(f) && ((d = this.lg[a].o && this.lg[a].o[f]) || (d = f), d = c + "," + d, this.options[d] = 1);
        "AMap.Map" === a && this.jP(a, b, ["mapStyle", "lang", "renderer", "zoom"])
    };
    V.a.jP = V.BuryPoint._addOptionsValue = function (a, b, c) {
        for (var d = 0, f, g; d < c.length; d++)f = c[d], b && b[f] && (g = {}, g[f] = b[f], this.gW(a, g))
    };
    V.a.gW = V.BuryPoint.addOptionsValue = function (a, b) {
        var c = this.lg[a].c, d, f;
        for (f in b)b.hasOwnProperty(f) && ((d = this.lg[a].o && this.lg[a].o[f]) || (d = f), d = c + "," + d, this.MB[d] = b[f])
    };
    V.a.send = V.BuryPoint.send = function () {
        var a = [], b = [], c = [], d = [], f = V.a, g;
        for (g in f.tL)1 !== f.nG[g] && a.push(g);
        for (g in f.vB)1 !== f.oG[g] && b.push(g + "=" + f.vB[g]);
        for (g in f.options)1 !== f.ZG[g] && c.push(g);
        for (g in f.MB)1 !== f.$G[g] && d.push(g + "=" + f.MB[g]);
        if (0 < a.length || 0 < b.length || 0 < c.length || 0 < d.length)new V.ra.Ca(V.q.dc + "://webapi.amap.com/count?" + ["type=f", "k=" + V.q.key, "u=" + V.q.El, "m=" + (V.j.U ? 1 : 0), "pf=" + V.j.lr, "methods=" + a.join("@"), "methodsParams=" + b.join("@"), "options=" + c.join("@"), "optionsValue=" + d.join("@")].join("&")),
            f.clear(a, b, c, d);
        window.setTimeout(f.send, 1E4)
    };
    V.a.clear = V.BuryPoint.clear = function (a, b, c, d) {
        for (var f = 0; f < a.length; f++)this.nG[a[f]] = 1;
        for (f = 0; f < b.length; f++)this.oG[b[f].split("=")[0]] = 1;
        for (f = 0; f < c.length; f++)this.ZG[c[f]] = 1;
        for (f = 0; f < d.length; f++)this.$G[d[f].split("=")[0]] = 1
    };
    ...
    V.W.extend = V.W.extend = function (a) {
        ...
        a.kN && (V.extend(c, a.kN), a.kN = null);
        a.ka && (V.extend.apply(null, [d].concat(a.ka)), a.ka = null);
        a.G && d.G && (a.G = V.extend({}, d.G, a.G));
        V.extend(d, a);
    ...
    V.extend = function (a) {
        ...
        d = 0;
        for (f = b.length; d < f; d += 1)for (c in g = b[d] || {}, g)Object.prototype.hasOwnProperty.call(g, c) && ("function" === typeof g[c] && "function" === typeof a[c] && (g[c].cb = a[c]), a[c] = g[c]);
        return a
    };
    V.W.Pn = function (a) {
    ...
    V.ea = {
        e: function (a, b, c, d, f) {
            ...
            g[a] = g[a] || [];
            f ? g[a].unshift({La: b, Me: c || this, Fk: d}) : g[a].push({La: b, Me: c || this, Fk: d});
            ...
            if (d && d[a])for (var f = 0; f < d[a].length; f +=
                1)if (!(d[a][f].La !== b && "mv" !== b || c && d[a][f].Me !== c)) {
                d[a].splice(f, 1);
                d[a].length || (d[a] = null);
                break
            }
            ...
            if (!this.rf(a))return this;
            var c = {type: a};
            b || "string" !== typeof b && "number" !== typeof b && "boolean" !== typeof b ? V.g.$A(b) ? c.value = b : c = V.extend(c, b) : c.value = b;
    ...
    V.yd = {
        set: function (a, b, c) {
            var d = this.zg;
            if (d && d[a]) {
                var d = d[a], f = "set" + this.lK(a);
                d[f] ? (d[f](b, c), c || this.ev(a, b)) : d.set(a, b, c)
            } else(this.Qi = this.Qi || {})[a] = b, c || this.ev(a, b)
        }, lK: function (a) {
            ...
            if (this[a + "Changed"])this[a + "Changed"](b); else this.QI && this.QI();
            this.w(a, b)
        }, p6: function (a, b, c) {
            var d = new (V.W.extend({ka: [V.ea, V.yd]}));
            d.QI = function () {
    ...
    V.q = {
        ...
        oC: "http://webst0{1,2,3,4}.is.autonavi.com/appmaptile?style=6&x=[x]&y=[y]&z=[z]",
    ...
    function xc(a) {
        ...
        "https" === b && (V.q.NN = "wss", V.q.ec = V.q.ec.replace("http", "https"), V.q.fr = V.q.fr.replace("http", "https"), V.q.Iu = V.q.Iu.replace("http", "https"), V.q.oC = V.q.oC.replace("http", "https"), V.q.ov = V.q.ov.replace("http", "https"), V.q.pv = V.q.pv.replace("http", "https"), V.q.Fr = V.q.Fr.replace("http", "https"), V.q.Kr = V.q.Kr.replace("http", "https"));
        var c = window.location.href;
        0 !== c.indexOf("http") &&
        window.parent && window.parent !== window && (c = window.parent.location.href);
        V.q.IY = c;
        ...
        d.type = "text/css";
        V.q.NX = "url(" + b + "://webapi.amap.com/theme/v1.3/openhand.cur),default";
        var f = ".amap-container{cursor:" + V.q.NX + ";}.amap-drag{cursor:url(" + b + "://webapi.amap.com/theme/v1.3/closedhand.cur),default;}";
        d.styleSheet ? (b = function () {
            try {
                d.styleSheet.cssText = f
            } catch (a) {
            }
        }, d.styleSheet.disabled ?
            setTimeout(b, 10) : b()) : d.appendChild(document.createTextNode(f));
    ...
    window.AMap && window.AMap.TC && window.AMap.TC.__load__ && window.AMap.TC.__load__(xc);
    V.hD = {UX: Math.PI / 180, K0: 180 / Math.PI};
    (function () {
        function a(a) {
        ...
        V.Ae = {
            oZ: function (b) {
                ...
                if (V.j.U) {
                    var d = [V.q.lm + "/callAPP?", "src=jsapi_q"];
                    ...
                    d.push("&wp=" + encodeURIComponent("viewMap?sourceApplication=jsapi_q&dev=0&poiname=" + b.name + "&lat=" +
                            b.y + "&lon=" + b.x));
                    d.push("&mo=" + encodeURIComponent(V.q.lm + "?q=" + c.join(",") + "&callapp=0&sourceApplication=jsapi_q"));
                    return d.join("")
                }
                ...
                if (V.j.U) {
                    var d = [V.q.lm + "/callAPP?", "src=jsapi_p"];
                ...
                if (V.j.U) {
                    var c = [V.q.lm + "/callAPP?", "src=jsapi_detail"];
                    ...
                    c.push("&mo=" + encodeURIComponent(V.q.lm + "/detail/index/poiid=" + b.id + "&sourceApplication=jsapi_detail"));
                    return c.join("")
                }
                ...
                if (V.j.U) {
                    var d = [V.q.lm + "/callAPP?", "src=jsapi_r_" + b.t];
                    ...
                    d.push("&mo=" + encodeURIComponent(V.q.lm +
    ...
    V.g = {
        Dv: [], Wa: 268435456, WW: "ASDFGHJKLQWERTYUIO!sdfghjkl", Dq: {
            start: function (a) {
                function b() {
                ...
                a.DX = new Date - a.startTime;
                this.cancel(a);
                a.Dq = Math.round(1E3 / (a.DX / (a.yN.length + 1)))
            }
        }, Jb: function (a) {
            if ("object" === typeof a && null !== a) {
                if (a.qo || this.zu(a, "Float32Array") || this.zu(a,
                        "Uint16Array"))return a;
            ...
            d = NaN;
            f = 0;
            for (g = a.length; f < g; f += 1)b = a[f], b = this.WW.indexOf(b), isNaN(d) ? d = 27 * b : (c.push(d + b - 333), d = NaN);
            return c
        }, H1: function (a, b) {
            for (var c = 1, c = 512 < b.length ? Math.round(Math.pow(b.length, 0.5)) : b.length,
                     d = Math.ceil(b.length / c), f = 0; f < d; f += 1) {
                var g = c * f, h = g + c;
        ...
        }(), vY: "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=", xh: Date.now ? function () {
            return Date.now()
        } : function () {
            ...
            return Object.prototype.toString.call(a).split(" ")[1].slice(0, -1).toLowerCase() ===
                b.toLowerCase()
        }, ka: function (a, b) {
            ...
            for (var c = "", d = 0, f = a.length; d < f; d++)c += String.fromCharCode((a.charCodeAt(d) - 256 - b + 65535) % 65535);
            return c
        }, QX: function (a, b) {
            ...
            return "undefined" !== typeof JSON && JSON.stringify ? V.g.mN(JSON.stringify(a)) : null
        }, B7: function (a, b) {
            ...
            this.gM || (this.gM = [], this.cB = !1);
            var c = this.gM, d = this;
            if ("img" === a.tagName.toLowerCase())c.push(a); else {
                a = a.getElementsByTagName("*");
                for (var f = 0; f < a.length; f += 1)c.push(a[f])
            }
            window.DD_belatedPNG && this.cB ? setTimeout(function () {
                b()
            }, 100) : this.cB || V.Ra.load("AMap.FixPng", b)
        }, ma: function (a) {
            if (V.g.isArray(a))if (V.g.isArray(a[0]))for (var b = 0; b < a.length; b += 1)a[b] = V.g.ma(a[b]); else if (b = typeof a[0], "string" === b || "number" === b)return new V.P(a[0], a[1]);
            return a
        }, uj: function (a) {
    ...
    (function () {
        ...
        function c(a) {
            var b = +new Date, c = Math.max(0, (V.j.Gg ? 50 : 20) - (b - d));
            d = b + c;
    ...
    V.g.s1 = window.requestIdleCallback ? window.requestIdleCallback.bind(window) : function (a) {
        var b = Date.now();
    ...
    V.g.RW = window.cancelIdleCallback ? window.cancelIdleCallback.bind(window) : function (a) {
        clearTimeout(a)
    };
    (function (a) {
        var b = 1, c = {};
        a.g.S1 = function (a, b) {
            if (c[a]) {
                ...
                g.result = b;
                if (g.nh) {
                    for (var h = g.nh, k = 0, l = h.length; k < l; k++)h[k].call(null, b);
                    g.nh = null
                }
            }
        };
        ...
        a.g.sA = function (d, f) {
            ...
            if (!a.j.SZ || "https:" === document.location.protocol)return d(null, g);
            var h;
            f && f.m3 && (h = "f" + b++, c[h] = {zr: 0});
            var k = null, l = !1;
    ...
    (function (a) {
        var b = a.W.extend({
            ka: [a.ea], D: function () {
                ...
                a.Im && a.Im.e("vecTileParsed.buildings", this.KR, this)
            }, SK: function (a) {
                return a.map.RF
            }, UJ: function (a) {
                return this.SK(a) ? a.map.Dx : null
            }, Q1: function (a, b) {
                if (b) {
                    var f = b.map;
                ...
                if (b) {
                    var f = b.map;
                    f && f.RF !== a && (f.RF = a, f.set("display", 0))
                }
            }, h4: function () {
            }, MF: function (a, b) {
                ...
                if (!b)return null;
                b = b.map.Ba;
                for (var d = 0, f = b.length; d < f; d++)if (a.S.Tg && b[d] instanceof a.S.Tg && b[d].xa && b[d].xa.length && (-1 !== b[d].xa.indexOf("building") || -1 !== b[d].xa.indexOf("poilabel")))return b[d];
                return null
            }, KY: function (a) {
                if (a = this.EJ(a)) {
                    if (a = a.Qa.get("tiles", null, !0))a = a[0]; else return null;
                    if (!a || !a.length)return null;
                    for (var b = [], f = 0, g = a.length; f < g; f++) {
                        var h = a[f];
                        h.ag && h.ag.bd && this.MF(h.ag.bd, b)
                    }
                    return b
                }
            }, KR: function (a) {
                if (a.Gv && a.Gv.ag && (a = a.Gv.ag.bd)) {
                    var b =
                        [];
                    this.MF(a, b);
                    this.w("vecTileParsed.builds.found", {LI: b})
                }
            }
        });
        a.Ze = new b
    ...
    (function (a) {
        ...
        function d(a) {
            function b(c, d) {
                function f(a, b, c) {
                    a = {Ko: Date.now(), Fo: h, error: a, result: b};
                    if (c)for (var g in c)c.hasOwnProperty(g) && (a[g] = c[g]);
                    d(a)
                }

                var g = c.MA, h = c.Fo, l = c.Hz, m = c.pq, v = c.pW || [], s = a._wkHandlers[g];
                s ? s[l] ? m ? s[l].apply(s, v.concat(f)) : f(null, s[l].apply(s,
            ...
            a.addEventListener("message", function (d) {
                ...
                var g =
                    d.data;
                d = g.q1 || [g];
                for (var h = d.length, u = 0, t = Date.now() - g.Ko, w = [], g = 0; g < h; g++)b(d[g], f)
            }, !1)
        }
        ...
        function f(d, h) {
            ...
            this.G.onReady && this.GB(this.G.onReady);
            this.xs = this.$Q();
                    ...
                    a.addEventListener("message",
                        function (a) {
                            ...
                            for (var c = 0, d = a.length; c < d; c++) {
                                ...
                                a:{
                                    g = f.Fo;
                                    for (var h = !!f.P_, k = 0, w = b.length; k < w; k++) {
                                        var v = b[k];
                                        if (g === v.Fo) {
                                            h || b.splice(k, 1);
                                            g = v;
        ...
        a.extend(f.prototype, {
            $Q: function () {
                ...
                this.pH = a;
                if (this.sn) {
                    for (var b = 0, c = this.sn.length; b <
                    c; b++)this.sn[b].apply(null, a);
                    this.sn.length = 0
                }
            }, Ct: function (a) {
                this.yU && this.xn.push.apply(this.xn, a)
            }, GB: function (a) {
                this.pH ? a.apply(null, this.pH) : (this.sn || (this.sn = []), this.sn.push(a))
            }, Fn: function (b) {
                var c = this;
                if (!c.jE) {
                    c.jE = !0;
                    var d = function (d, f) {
                        d && a.j.XK && console.warn(d);
                        c.EU.call(c, d, f);
                        b && b(d, f)
                    };
                    a.j.XK ? this.xU(function (a, b) {
                        b ? this.hS(b, function (a, c) {
                            a ? d(a) : (this.$s(c), this.ez = c, this.xn.length = 0, this.Qs = null, d(null, {
                                zW: b,
                                w3: c
                            }))
            ...
            JK: function (a, b, c) {
                ...
                d.$s(null, g);
                d.GB(function (h) {
                    h ? c(h) : d.ez ? (h = d.jF(b, d.qx(d.lp, a)), d.ez.sendMessage(f.FA + ":injectCode", h, function (a, b) {
                        a || d.$s(d.ez, g);
                        c(a, b)
                ...
                var b = {}, c;
                for (c in a)a.hasOwnProperty(c) && this.YD(c, a[c], b);
                return b
            }, YD: function (a, b, c) {
                b = b.call(null, !1);
                for (var d in b)b.hasOwnProperty(d) && (c[a + ":" + d] = b[d], a === this.xs && (c[d] = b[d]))
            }, $s: function (a, b) {
                b || (this.Qs || (this.Qs = this.PP(this.Ks)), b = this.Qs);
                for (var c in b)if (b.hasOwnProperty(c)) {
                    var d = b[c];
                    "function" === typeof d && (this[c] = this.pR(c, d, a))
                }
                this.yU = !!a
            }, jF: function (a, b) {
                var c = a.toString(),
                ...
                for (d in this.Ks)if (this.Ks.hasOwnProperty(d)) {
                    var g = this.jF(this.Ks[d], this.qx(b, d));
                    g && c.push(g)
                }
                ...
                var h = b.join(";\n") + ";\n" + c.join(";\n"), c = this.G.hostWorker, r = this;
                c && c !== r ? c.GB(function (b, c) {
                    b ? a.call(r, b) : c.w3.sendMessage(f.FA + ":injectCode", h, function (b) {
                        b ? a.call(r, b) : a.call(r, null, c.zW)
                    })
                }) : setTimeout(function () {
                    a.call(r, null, r.AV(h))
                }, 0)
            }, AV: function (a) {
                ...
                var c = 1, d = b.TO, f = this, g = !!f.G.batchSend;
                return function (h) {
                    var r = Array.prototype.slice.call(arguments, 1), u = "function" === typeof r[r.length - 1] ? r.pop() : null, t = f.lp, w = h.split(":"), v = f.xs;
                    1 < w.length && (h = w[1], v = w[0]);
                    r = {Ko: a.g.xh(), MA: f.qx(t, v), pq: !!u, Fo: t + "_" + c++, Hz: h, pW: r};
                    u && d.push({Hz: r.Hz, MA: r.MA, Ko: r.Ko, Fo: r.Fo, pq: u});
                    g ? f.xP(b, r) : f.qn(b, r)
                }
            }, qn: function (a, b) {
                if (this.xn.length) {
                ...
                if (!b.kH) {
                    var d = this;
                    b.kH = setTimeout(function () {
                        b.kH = null;
                        var c = b.by;
                        c.length && (d.qn(b, 1 === c.length ? c[0] : {Ko: a.g.xh(), q1: c}), c.length = 0)
                    }, 0)
                }
            }, sV: function (a) {
                var b = this;
                ...
                c.sV(a);
                var d = this.tQ(a);
                if (f.hQ)b.call(c, null, {sendMessage: d}); else {
                    f.hQ = !0;
                    var g = [c.dF() +
    ...
    (function () {
        if (!V.Ld) {
            V.Ld = {De: {}, Zq: {}};
            var a = V.Ld, b = V.Ld.De, c = V.g;
            b.start = function (b) {
                a.Zq[b.id] = {
                    C: b.C, time: {IK: c.xh()}, PW: function () {
                        return c.xh() - this.time.IK
                    }
                }
            };
            b.end = function (b) {
                var d = a.Zq[b.id], h = d.time, d = c.bind(d.PW, d), k = b.index, l = b.key;
            ...
            b.send = function (b) {
                var c = V.q.dc + "://webapi.amap.com/count?", h = V.extend(d({C: a.Zq[b.id].C}), b.params || {}), k = V.g;
                b.params && b.params.rs && !b.params.type && (b = a.Zq[b.id].time, delete b.IK, h = V.extend(h, b));
                b = [];
    ...
    V.f = {
        get: function (a) {
            ...
            var b =
                0, c = 0, d = a, f = document.body, g = document.documentElement, h, k = V.j.Vq;
            do {
                b += d.offsetTop || 0;
                c += d.offsetLeft || 0;
            ...
            do {
                ...
                b -= d.scrollTop || 0;
                c -= d.scrollLeft || 0;
                V.f.eY() || !V.j.q3 && !k || (c += d.scrollWidth - d.clientWidth, k && "hidden" !==
                V.f.Ic(d, "overflow-y") && "hidden" !== V.f.Ic(d, "overflow") && (c += 17));
                d = d.parentNode
            } while (d);
            return new V.K(c, b)
        }, eY: function () {
            V.f.DQ || (V.f.DQ = !0, V.f.CQ = "ltr" === V.f.Ic(document.body, "direction"));
            return V.f.CQ
            ...
            this.OT || (this.OT = document.onselectstart, document.onselectstart = V.g.BJ)
        }, tJ: function () {
        }, Zn: function (a, b) {
            if (a &&
            ...
            return V.f.jK(b.add(b.Bc(-1 * a))) + (" scale(" + a + ") ")
        }, x7: function (a, b, c) {
            a.df = b;
            !c && V.j.kW ? (b = V.f.jK(b), c = a.style[V.f.Nd].split("rotate"), 1 < c.length ? (c[0] = b, a.style[V.f.Nd] = c.join("rotate")) : a.style[V.f.Nd] = b, V.j.D_ && (a.style.WebkitBackfaceVisibility = "hidden")) : (a.style.left = b.x + "px", a.style.top = b.y + "px")
        }, Vc: function (a) {
        ...
        rotate: function (a, b, c) {
            ...
            d ? (a.style[d] = "" + (" rotate(" + b + "deg)"), a.style[V.f.Sk[d] + "-origin"] = c.x + "px " + c.y + "px") : (d = Math.cos(b * Math.PI / 180), b = Math.sin(b * Math.PI / 180), a.style.filter = "progid:DXImageTransform.Microsoft.Matrix()", 0 < a.filters.length && (a = a.filters.item(0), a.I3 = -c.x * d + c.y * b + c.x, a.J3 = -c.x * b - c.y * d + c.y, a.M11 = a.M22 = d, a.M12 = -(a.M21 = b)))
        }, sZ: function (a, b, c) {
            var d = V.f.Nd;
            c = c || {x: a.clientWidth / 2, y: a.clientHeight / 2};
            return d ? V.f.Sk[d] + ":" + ("" +
            (" rotate(" + b + "deg)")) + ";" + (V.f.Sk[d] + "-origin:" + c.x + "px " + c.y + "px") : ""
        }, Fi: function (a, b, c) {
            a.width = b;
            a.height = c
    ...
    (function () {
        var a = V.f.GC(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]), b;
        V.extend(V.f, {
            lJ: function () {
    ...
    V.f.Nd = V.f.GC(["WebkitTransform", "OTransform", "MozTransform", "msTransform", "transform"]);
    V.f.Sk = {
        transform: "transform",
    ...
    V.f.kw = V.f.GC(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]);
    V.f.V3 = "webkitTransition" === V.f.kw || "OTransition" === V.f.kw ? V.f.kw + "End" : "transitionend";
    V.B = {
        e: function (a, b, c, d) {
            function f(b) {
                b = b || window.event;
            ...
            var g = V.g.Bb(a) + "_" + V.g.Bb(c) + "_" + V.g.Bb(d || a), h = b + g;
            if (a[h])return this;
            var k = b;
            V.j.FJ && "mousewheel" === b && (b = "DOMMouseScroll");
            ...
            if (V.j.iM && 0 === b.indexOf("touch"))return a[h] = f, this.cW(a, b, f, g);
            V.j.vd && "dblclick" === b && this.aW && this.aW(a, f, g);
            ...
            var f = a[d];
            V.j.FJ && "mousewheel" === b && (b = "DOMMouseScroll");
            !V.j.bo || "mouseover" !== b && "mouseout" !== b || (b = "mouseover" === b ? "mouseenter" : "mouseleave");
            V.j.iM && -1 < b.indexOf("touch") ? this.W0(a, b, c) : V.j.vd && "dblclick" === b && this.S0 ? this.S0(a, c) : "removeEventListener" in
            ...
            V.j.vd && (V.B.e(a, "touchstart", b, this), V.B.e(a,
                "touchmove", b, this), V.B.e(a, "touchend", b, this));
            V.j.U || (V.B.e(a, "mousedown", b, this), V.B.e(a, "mouseup", b, this), V.B.e(a, "mousemove", b, this));
            V.j.hM && (V.B.e(a, "pointerdown", b, this), V.B.e(a, "pointerup", b, this), V.B.e(a, "pointermove", b, this));
            V.j.J_ && (V.B.e(a, "MSPointerDown", b, this), V.B.e(a, "MSPointerUp", b, this), V.B.e(a, "MSPointerMove", b, this))
        ...
        K1: function (a) {
            return a && a.getBoundingClientRect ? (a.nw = a.getBoundingClientRect(), a.LD = [a.clientLeft, a.clientTop], !0) : !1
        }, V2: function (a) {
            a.nw && (a.nw = null, a.LD = null)
        }, BY: function (a, b) {
            var c = b.nw || b.getBoundingClientRect(), d = b.LD || [b.clientLeft, b.clientTop];
            return new V.K(a.clientX - c.left - d[0], a.clientY - c.top - d[1])
        }, Jg: function (a, b) {
            if (b && b.getBoundingClientRect)return this.BY(a, b);
            var c = document.body, d = document.documentElement, c = new V.K(V.j.vd ? a.pageX : a.clientX + (c.scrollLeft || d.scrollLeft), V.j.vd ? a.pageY :
            a.clientY + (c.scrollTop || d.scrollTop));
            return b ? c.Xa(V.f.EA(b)) : c
        }, VK: function (a) {
            return 1 === a.which || 0 === a.button || 1 === a.button
        }
    };
    V.extend(V.B, {
        ay: [], rG: !1, cW: function (a, b, c, d) {
            switch (b) {
                case "touchstart":
            ...
            }, document.documentElement.addEventListener(this.qi("pointerup"), a, !1), document.documentElement.addEventListener(this.qi("pointercancel"), a, !1), this.rG = !0);
            return this
        }, eW: function (a, b, c, d) {
            function f(a) {
            ...
            a.addEventListener(this.qi("pointercancel"),
                f, !1);
            return this
        }, W0: function (a, b, c) {
            c = a["_amap_" + b + c];
            switch (b) {
                ...
                case "touchmove":
                    ...
                    break;
                case "touchend":
                    a.removeEventListener(this.qi("pointerup"), c, !1), a.removeEventListener(this.qi("pointercancel"), c, !1)
            }
            return this
        }
    });
    (function () {
        ...
        var c = document.attachEvent, d = navigator.userAgent.match(/(Trident|Edge)/), f = V.g.Ve, g = V.g.Hl;
        V.extend(V.B, {
            hW: function (f, g) {
                if (!f.Ni)if (f.Ni = [], c)f.Oi = f, f.attachEvent("onresize", a); else {
                ...
                b.Ni.length || (c ? b.detachEvent("onresize", a) : (b.Oi.contentDocument.defaultView.removeEventListener("resize", a),
                    b.Oi = !b.removeChild(b.Oi)))
            }, lX: function (a) {
                a.Ni = null;
                if (a.Oi) {
                    var b = a.Oi;
    ...
    V.Ra = {
        E_: V.q.pb + "/maps", Nn: V.W.Nn, qB: 0, vo: [], Ml: {}, tf: function (a, b) {
            function c() {
                d += 1;
                d === f.length && b && b()
            }
            ...
            for (g = 0; g < f.length; g += 1)this.aA(f[g], c)
        }, Cu: function (a) {
            ...
            if (1 === c.status)b && b(); else {
                ...
                if (0 === c.status) {
                    this.I0(a);
                    var g = this;
                    g.qB || (g.qB = 1, window.setTimeout(function () {
                        g.qB = 0;
                        var a = g.E_ + "/modules?v=" + V.q.cz + "&key=" + V.q.key + "&m=" + g.vo.join(",") + "&vrs=" + V.q.wg;
                        V.Ra.Nw(g.vo.join(","));
                        g.vo = [];
                        c.uv = g.m_(a)
                    }, 1));
            ...
            if (c) {
                ...
                for (var g = 0, c = function () {
                    g += 1;
                    g === d.length && b && b()
                }, f = 0; f < d.length; f += 1)this.aA(d[f], c)
            } else this.aA(a, b)
        }, I0: function (a) {
            ...
            c.status = 1;
            for (var f = 0, g = c.Hn.length; f < g; f += 1)c.Hn[f]();
            c.Hn = []
        }, Y4: function (a, b) {
            var c = this;
            c.timeout = setTimeout(function () {
                1 !==
                c.Ml[a].status ? (c.remove(a), c.load(a, b)) : clearTimeout(c.timeout)
            }, 5E3)
        }, Zt: function (a) {
            this.Ml[a] || (this.Ml[a] = {}, this.Ml[a].status = 0, this.Ml[a].Hn = []);
            return this.Ml[a]
        }, remove: function (a) {
            this.Ml[a] = null
        }, m_: function (a) {
    ...
    window._cssload_ = function (a, b, c) {
        try {
            !c && window.localStorage && b && "" !== b && V.j.qj && window.localStorage.setItem("_AMap_" + a, JSON.stringify({
                css: b,
                version: V.q.wg
            }))
        } catch (d) {
        ...
        f.type = "text/css";
        -1 === V.q.pb.indexOf("webapi.amap.com") && (b = b.replace(eval("/webapi.amap.com/gi"), V.q.pb.split("://")[1]));
    ...
    (function (a) {
        var b = V.j;
        if (!V.indexedDB && b.ud) {
            var c = a.indexedDB || a.webkitIndexedDB || a.msIndexedDB || a.mozIndexedDB, d = a.IDBKeyRange || a.X7 || a.K6 || a.J6;
            if (c) {
                var f = V.g, g = null;
                a = "amap-jsapi" + (a.K3 ? "-debug" : "");
                var h = V.extend({}, V.ea), k;
                try {
                    k = c.open(a), k.onsuccess = function () {
                        g = this.result;
                        h.w("dbReady", {status: "success"})
                    }, k.onerror = function () {
                        h.w("dbReady", {status: "error"})
                    }, k.onblocked = function () {
                        h.w("dbReady", {status: "blocked"})
                ...
                var b = function (a) {
                    ...
                    for (var c = -1, d = 0, f = b.length; d < f; d++)if (b[d] > a) {
                        c = d;
                        break
                    }
                    return c
                ...
                V.indexedDB = {
                    fq: b(function (a, b) {
                        g ? "function" === typeof a && a() : h.e("dbReady", function (c) {
                        ...
                        if (f.isArray(a)) {
                            ...
                            c.openCursor(d.bound(a[0], a[a.length - 1])).onsuccess = function (c) {
                                if (c = c.target.result) {
                                    var d = f.indexOf(h, c.value.tileKey);
                                    -1 !== d && (g[d] = c.value);
    ...
    (function () {
        ...
        function d() {
            var a = t.data.keys.length, b = Math.floor(a / 2);
        ...
        function g() {
            ...
            a && (a.Pv === t.data.Pv && a.vI === t.data.vI ? t.data = a : f())
        }

        function h() {
            t.data = {Pv: p.Qo, vI: V.q.wg, keys: [], Hf: {}, mg: {}};
            t.Cj = {}
        }
        ...
        function m(a) {
            if ("object" === typeof a && null !== a) {
                ...
                } else if (q.zu(a, "Float32Array"))b.push("__Float32Array"), b.push(Array.prototype.slice.call(a)); else if (q.zu(a, "Uint16Array"))b.push("__Uint16Array"), b.push(Array.prototype.slice.call(a)); else for (d in b = {}, a)a.hasOwnProperty(d) && (b[d] = m(a[d]));
                return b
            }
            return a
        }
        ...
        var p = V.j, q = V.g;
        if (!V.dl && V.j.ne && (p.ud || p.qj)) {
            var r = V.indexedDB, u = function (a, b) {
                return [a ? 1 : 0, p.U ? 1 : 0, b ? 1 : 0].join()
            }, t = {Zv: 1E3, key: "_AMap_data.tileKeys"}, w = [], v = {
                getItem: function (a, b) {
                    ...
                    var d = b;
                    c && (d = JSON.stringify(b), 1.5 < d.length / 1024 / 1024 && Object.keys(b.mg).length && (b.mg = {}, d = JSON.stringify(b)));
                    try {
            ...
            V.dl = {
                get: function (c, d) {
                    function g(a) {
                        var b = {OA: u, C_: M, Hf: t.data.Hf};
                        /\|limg/.test(W[0]) ? b.f_ = h(a) : b.ce = k(a);
                        d && d(null, b)
                    }
                    ...
                    var v = c.B2, u = [], W = [], M = [], Q = [];
                    if ("FS" !== c.type && !t.data.keys.length)return d({code: 1});
                    v.forEach(function (a) {
                        var d = b({yf: a.key, url: c.url, Zd: c.Zd, ha: c.S.ha, td: c.td});
                        "FS" !== c.type || p.ud ? "FS" !== c.type || /\|w\|/.test(d) ? q.ka(t.data.keys, d) ? (u.push(a), W.push(d)) : M.push(a) : (w.push(d), t.data.mg[d] ? (u.push(a), W.push(d), Q.push({
                            ...
                            d) ? (u.push(a), W.push(d)) : M.push(a)) : /\|w\|/.test(d) ? M.push(a) : (w.push(d), t.data.mg[d] ? (u.push(a), W.push(d), Q.push({
                            data: n(t.data.mg[d]),
                            yf: d
                        })) : M.push(a))
                    });
                    if (W.length) {
                        ...
                        r.get(x, function (b, h) {
                            if (b)3 === b.code ? p.ud = !1 : f(), d && d({code: 1}); else {
                                "FS" === c.type && h.length && h.forEach(function (a) {
                                    /\|w\|/.test(a.tileKey) || (t.data.mg[a.tileKey] = m(a.data))
                                });
                                if (Q.length) {
                                    var k =
                                        [];
                                ...
                                h.length === W.length ? (g(h), a(W)) : (f(), d && d({code: 1}))
                            }
                        })
                    } else d && d({code: 1})
                }, Dj: function (a) {
                    a.Io.forEach(function (c) {
                        c = b({yf: c.key, url: a.url, Zd: a.Zd, ha: a.S.ha, td: a.td});
                        t.Cj[c] && delete t.Cj[c]
                    })
                }, set: function (a, c) {
                    a.vdataVersion && a.vdataVersion !== t.data.Pv && (k(a.vdataVersion), f(), c && c({code: 2}));
                    if (a.Ng) {
                        var d = b({yf: a.yf, url: a.url, Zd: a.Zd, ha: a.S.ha, td: a.td});
                        if (p.ud || q.ka(w, d)) {
                            var g =
                                t.Cj[d] || [];
                            g.push(q.Jb(a.data));
                    ...
                    } else a.ce.forEach(function (c) {
                        var d = b({yf: c.yf, url: a.url, Zd: a.Zd, ha: a.S.ha, td: a.td});
                        if (p.ud || q.ka(w, d)) {
                            var f = t.Cj[d] || {};
                            f[c.Mc] = q.Jb(c);
                            t.Cj[d] = f
                    ...
                    t.data.Hf = {"x-vd-v": a["x-vd-v"], tv: a.tv, vdv: a.vdv, bgc: a.bgc}
                }, flush: function () {
                    var a = !0;
                    return function () {
                        var b = this;
                        if (a) {
                            if (Object.keys(t.data.mg).length)for (var c in t.data.mg)t.data.mg.hasOwnProperty(c) && !q.ka(w, c) && delete t.data.mg[c];
                            p.ud ? r.count(function (a, c) {
                                a || (c !== t.data.keys.length ? (r.clear(function (a) {
                                    !a &&
                                    b.As()
                                }), t.data.keys = []) : b.As())
                            }) : b.As();
                    ...
                    var a = {}, b = [], d = Object.keys(t.Cj), g = [];
                    d.length ? (d.forEach(function (c) {
                        var d = t.Cj[c];
                        c.split("|").pop().split(",").every(function (a) {
                            return "limg" === a ? d && 3 === d.length : d && void 0 !== d[a]
                        }) ? (g.push(c), q.ka(w, c) && void 0 === t.data.mg[c] && (t.data.mg[c] = m(d)), b.push({
                            tileKey: c,
                            data: d
                        })) : a[c] = d
                    }), b.length && (p.ud ? r.add(b, function (a) {
                        a ? 3 !== a.code ? f() : p.ud = !1 : (t.data.keys = t.data.keys.concat(g), v.setItem(t.key, t.data, !0), c())
                    }) : v.setItem(t.key,
                        t.data, !0)), t.Cj = a) : (v.setItem(t.key, t.data, !0), c())
                }
            };
            g()
        }
    ...
    V.P = V.W.extend({
        D: function (a, b, c) {
            ...
            return V.g.qf(this.M, 6)
        }, WJ: function () {
            return V.g.qf(this.O, 6)
        }, add: function (a, b) {
            return new V.P(this.M + a.M, this.O + a.O, b)
        }, Xa: function (a, b) {
            return new V.P(this.M - a.M, this.O - a.O, b)
        }, Ob: function (a, b) {
            return new V.P(this.M / a, this.O / a, b)
        }, Bc: function (a, b) {
            return new V.P(this.M *
                a, this.O * a, b)
        }, Kf: function (a) {
            a = V.g.ma(a);
            if (a instanceof V.P) {
                var b = Math.cos, c = 0.017453292519943295 * this.O, d = 0.017453292519943295 * a.O;
                a = 0.017453292519943295 * a.M - 0.017453292519943295 * this.M;
                b = (1 - b(d - c) + (1 - b(a)) * b(c) * b(d)) / 2;
                return 12756274 * Math.asin(Math.sqrt(b))
            }
            if (a instanceof Array)return this.$X(a)
        }, $X: function (a) {
            a = V.g.ma(a);
            for (var b = Infinity, c = 0, d = 1, f = a.length; d < f; c = d, d += 1)c = V.Tc.YI([this.M, this.O], [[a[c].M, a[c].O], [a[d].M, a[d].O]]), b = Math.min(b, this.Kf(new V.P(c[0], c[1])));
            return b
        }, offset: function (a,
                             b) {
            if (isNaN(a) || isNaN(b))return !1;
            var c = 2 * Math.asin(Math.sin(Math.round(a) / 12756274) / Math.cos(this.O * Math.PI / 180)), c = this.M + 180 * c / Math.PI, d = 2 * Math.asin(Math.round(b) / 12756274);
    ...
    V.P.hZ = function (a, b, c) {
        c = c + 1 || Math.round(Math.abs(a.M - b.M));
        if (!c || 0.001 > Math.abs(a.M - b.M))return [];
        var d = [], f = V.hD.UX, g = V.hD.K0, h = Math.asin, k = Math.sqrt, l = Math.sin, m = Math.pow, n = Math.cos, p = Math.atan2, q = a.O * f;
        a = a.M * f;
        var r = b.O * f;
        b = b.M * f;
        for (var h = 2 * h(k(m(l((q - r) / 2), 2) + n(q) * n(r) * m(l((a - b) / 2), 2))), u, t, w, v, f = 1; f < c; f += 1)u = 1 / c * f, t = l((1 - u) * h) / l(h), w = l(u * h) / l(h), u = t * n(q) * n(a) + w * n(r) * n(b), v = t * n(q) * l(a) + w * n(r) * l(b), t = t * l(q) + w * l(r), t = p(t, k(m(u, 2) + m(v, 2))), u = p(v, u), d.push(new V.P(u * g, t * g));
        return d
    };
    V.P.Pn({
        YJ: "getLng",
    ...
    V.wd = V.W.extend({
        D: function () {
            if (2 === arguments.length)this.mb = V.g.ma(arguments[0]), this.eb = V.g.ma(arguments[1]); else if (4 === arguments.length)this.mb = new V.P(arguments[0], arguments[1]), this.eb = new V.P(arguments[2], arguments[3]); else throw"Invalid Object: Bounds(" + arguments.join(",") + ")";
        }, Mq: function () {
            return this.mb
        }, Kq: function () {
            return this.eb
    ...
    V.ac.Pn({Pe: "getWidth", Ne: "getHeight", toString: "toString"});
    V.fe = V.W.extend({
        D: function () {
            if (2 === arguments.length)this.hb = arguments[0], this.$b = arguments[1]; else if (1 === arguments.length && arguments[0] instanceof Array || 4 === arguments.length) {
            ...
            var b;
            a instanceof V.fe ? (b = a.hb, a = a.$b) : b =
                a;
            ...
            b || 0 === b || (b = 20);
            var c = this.hb, d = this.$b, f = a.hb, g = a.$b, h = g.y >= c.y - b && f.y <= d.y + b;
    ...
    V.A = {};
    V.A.DI = function (a) {
        for (var b = [Infinity, Infinity, -Infinity, -Infinity], c = 0, d = a.length; c < d; c += 1)V.A.yJ(b, a[c]);
        return b
    };
    V.A.EI = function (a, b, c) {
        var d = Math.min.apply(null, a);
        a = Math.max.apply(null, a);
        var f = Math.min.apply(null, b);
        b = Math.max.apply(null, b);
        return V.A.HX(d, a, f, b, c)
    };
    ...
    V.A.transform = function (a, b, c) {
        ...
        b(a, a, 2);
        return V.A.EI([a[0], a[2], a[4], a[6]], [a[1], a[3], a[5], a[7]], c)
    };
    V.wd.Yb({
        D: function () {
    ...
    V.bs = V.W.extend({
        D: function (a, b, c, d) {
            ...
            return this.$H(a.Jb(), b)
        }, $H: function (a, b) {
            b = b || 1;
            a.x = b * (this.VD * a.x + this.eE);
            a.y = b * (this.lE * a.y + this.FE);
            return a
        }, W2: function (a, b) {
            b = b || 1;
            return new V.K((a.x / b - this.eE) / this.VD, (a.y / b - this.FE) / this.lE)
        }
    });
    V.Mi = V.W.extend({
        D: function (a) {
    ...
    V.Mi.EO = new V.Mi({
        MAX_LATITUDE: 85.0511287798, project: function (a) {
            var b = Math.PI / 180, c = this.Yv, c = Math.max(Math.min(c, a.O), -c);
            a = a.M * b;
    ...
    V.Mi.yD = {
        Yv: 85.0840591556, fw: 6356752.3142, ew: 6378137, rb: function (a) {
            var b = Math.PI / 180, c = this.Yv, d = Math.max(Math.min(c, a.O), -c), f = this.ew, c = this.fw;
            a = a.M * b * f;
            b *= d;
            f = c / f;
            f = Math.sqrt(1 - f * f);
            ...
            for (var c = 180 / Math.PI, d = this.ew, f = this.fw, g = a.x * c / d, d = f / d, d = Math.sqrt(1 - d * d), f = Math.exp(-a.y / f), h = Math.PI / 2 - 2 * Math.atan(f), k = 15, l = 0.1; 1E-7 < Math.abs(l) && (k -= 1, 0 < k);)l = d * Math.sin(h), l = Math.PI /
    ...
    V.xg.Qr = {
        lB: function (a, b) {
            var c = this.ue.rb(a), d = this.scale(b);
            return this.Gr.$H(c, d)
        }, ZB: function (a, b, c) {
            b = this.scale(b);
            a = this.Gr.W2(a, b);
            return this.ue.Bf(a, c)
        }, rb: function (a) {
            return this.ue.rb(a)
        }, scale: function (a) {
            return 256 << a
    ...
    V.xg.$N = V.extend({}, V.xg.Qr, {
        code: "EPSG:3857",
        ue: V.Mi.EO,
        Gr: new V.bs(0.5 / Math.PI, 0.5, -0.5 / Math.PI, 0.5),
        rb: function (a) {
            return this.ue.rb(a).Bc(6378137)
        }
    });
    V.xg.ZN = V.extend({}, V.xg.Qr, {
        code: "EPSG:3395", ue: V.Mi.yD, Gr: function () {
            var a = V.Mi.yD;
            return new V.bs(0.5 / (Math.PI * a.ew), 0.5, -0.5 / (Math.PI * a.fw), 0.5)
        }()
    });
    V.xg.aO = V.extend({}, V.xg.Qr, {code: "EPSG:4326", ue: V.Mi.xD, Gr: new V.bs(1 / 360, 0.5, -1 / 360, 0.25)});
    V.xg.T3 = V.extend({}, V.xg.Qr, {ue: V.Mi.xD, Gr: new V.bs(1, 0, 1, 0)});
    V.oL = {
        rb: function (a, b) {
            a = V.g.ma(a);
            return this.wq.lB(a, b || this.get("zoom"))
        }, Bf: function (a, b, c) {
            return this.wq.ZB(a, b || this.get("zoom"), c)
        }, x6: function (a, b) {
            return this.rb(a, b)
        }, B5: function (a, b) {
            return this.Bf(a, b)
    ...
    var yc = V.W.extend({
        ka: [V.ea, V.yd],
        G: {center: new V.P(116.397128, 39.916527), zoom: 13, rotation: 0, crs: "EPSG3857"},
        D: function (a) {
    ...
    var Gc = V.W.extend({
        ka: [V.ea, V.yd, V.oL], G: {
            ...
            V.a.add(this.CLASS_NAME, "setMapStyle", a);
            ...
            "en" !== a && "zh_cn" !== a && "zh_en" !== a || a === this.getLang() || (this.set("lang", a), this.ti && this.ti.HM(this))
        }, getLang: function () {
            ...
            var c = this;
            (new V.ra.Ca(V.q.ec + "/v3/config/district?subdistrict=0&extensions=all&key=" + V.q.key + "&s=rsv3&output=json&keywords=" + a, {callback: "callback"})).e("complete", function (a) {
            ...
            var c = V.q.ec + "/v3/geocode/regeo?&extensions=&&key=" + V.q.key + "&s=rsv3&output=json&location=" + (b || this.get("center", null, !0));
            (new V.ra.Ca(c, {callback: "callback"})).e("complete", function (b) {
            ...
            this.wq = this.IX(b.crs || this.G.crs, b.center || this.G.center);
            this.sW(c, b);
            d = b.lang;
            ...
            this.JX(this.G);
            var f = this;
            this.ye({overlays: [], infos: {}, controls: {}});
            c = [];
            ...
            V.Ra.tf(c, function () {
                if (!f.get("destroy")) {
                    ...
                    b.wq = f.wq;
                    f.Uc(["zoomSlow", "panTo", "targetLevel", "render"],
                        b);
                    b.Uc(["size", "bounds"], f);
                    f.loaded = !0;
                    f.w("coreMapCreated")
            ...
            if ((a = new V.wd(a[0], a[1], a[2], a[3])) && b && d) {
                for (var f = c[1]; f > c[0]; f -= 1) {
                    var g = this.rb(a.mb, f), h = this.rb(a.eb, f);
            ...
            if (!(b && b.center && b.zoom)) {
                var c = this.OY(V.q.Bd, a, b.zooms);
            ...
            if (a && !("dv" < a)) {
                ...
                b && c && (V.j.ne && (d || "all" !== b || "normal" !== c && "amap://styles/normal" !== c) ? (this.set("baseRender",
                    "v"), this.PB = a) : this.PB && (this.set("baseRender", this.PB), this.PB = null))
            }
        }, ZV: function () {
            var a = this;
            AMap.plugin(["AMap.IndoorMap"], function () {
                !a.zh && a.C && (a.indoorMap = a.zh = new AMap.IndoorMap({
                    innerLayer: !0,
                    map: a
                }), a.xC(), V.g.Ve(function () {
            ...
            this.Nu = !1;
            for (var b = 0; b < a.length; b += 1)a[b].getMap() !== this && a[b].setMap(this), a[b].Nu && (this.Nu = !0);
            this.xC()
        ...
        getAdcode: function () {
            ...
            a.layers && 0 !== a.layers.length || (b = new X, a.layers = [b], b.iz = !0, this.set("defaultLayer", b, !0));
            if (b = a.view)b.G.rotation && (a.rotation = b.G.rotation), b.G.center && (a.center = b.G.center), b.G.zoom && (a.zoom = Math.max(a.zooms[0], Math.min(a.zooms[1], b.G.zoom))), b.G.crs && (a.crs = b.G.crs);
            ...
            var b = this.get("layers");
            a = V.g.indexOf(b, a);
            -1 !== a && this.set("layers", V.g.jj(b, a))
        }, iv: function (a) {
            var b = this.get("overlays");
            ...
            !V.j.nd && this.get("rotateEnable") && this.set("rotation", a)
        }, getRotation: function () {
            V.a.add(this.CLASS_NAME, "getRotation");
            return this.get("rotateEnable") && this.get("rotation") || 0
        }, getBounds: function () {
            V.a.add(this.CLASS_NAME, "getBounds");
            var a = this.getCoordsBound(), b = a.$b.x, c = a.hb.y, a = new V.K(a.hb.x, a.$b.y), b = new V.K(b, c);
            ...
            b = b ? Number(b) : 0;
            var h = this.VL || this.get("zooms")[1];
            g = this.getSize().Lo();
            var k = 0, l = 0;
            if (f) {
            ...
            f = this.get("zooms");
            for (c && (g = g.Xa(c)); h > f[0] && !(c = this.rb(a.mb, h), m = this.rb(a.eb, h), a.mb.M > a.eb.M && (m.x += this.rb(new V.P(180, 0), h).x), Math.abs(m.x - c.x) < g.x && Math.abs(c.y - m.y) <
            g.y); h -= 1);
            g = V.j.U ? 17 : 18;
            ...
            this.set("overlays", []);
            if (this.map && this.map.Ba)for (var a = this.map.Ba, c = a.length, b = 0; b < c; b += 1)a[b].Qa instanceof Bc && a[b].Qa.setMap(null)
        },
        destroy: function () {
            ...
            var b = V.g.Bb(a), c = this.get("controls") || {};
            c.zc = c.zc || {};
            c.zc[b] || (c.zc[b] = a);
            c.add =
                c.add || [];
            ...
            for (var f = a.length, c = 0; c < a.length; c += 1)V.Ra.load(a[c], function () {
                f -= 1;
                0 === f && b()
            });
            return this
            ...
            if (d) {
                for (var f =
                    [], g = 0; g < c.length; g += 1)c[g] instanceof d && (b || !c[g].ga && !c[g].isOfficial) && f.push(c[g]);
                return f
            }
            if (!b) {
                f = [];
            ...
            d = this.get("layers");
            f = [];
            if (d)for (var g = 0, h = d.length; g < h; g += 1)d[g] instanceof Bc && f.push(d[g]);
            return c.concat(f)
        }, triggerResize: function () {
            this.map && this.map.By()
        }, refreshSize: function () {
            this.ps = this.QY()
        }, QY: function () {
            return V.f.NJ(this.C)
        }, getSize: function () {
            V.a.add(this.CLASS_NAME, "getSize");
            (!this.ps || 10 > this.ps.width *
            this.ps.height) && this.refreshSize();
            return this.ps
            ...
            f = (this.loaded && this.map && this.map.Wb ? this.rb(this.map.Wb.sN) : this.rb(this.get("center"))).add(new V.K(-f,
                -a));
            f = this.Bf(f);
            ...
            var f;
            if (a)if (a instanceof Fc)a = [a]; else {
                if (!(a instanceof Array))return null
            } else a = this.getAllOverlays();
            for (var g = 0; g < a.length; g += 1) {
                var h = a[g];
                !h.get("visible") || h instanceof Ac || h instanceof zc || (h = h.getBounds()) && (f = f ? h.U2(f) : h)
            }
            ...
            for (var b =
                0; b < a.length; b += 1)a[b].set("map", this, !0);
            this.set("layers", a)
        }, getLayers: function () {
        ...
        drawCircle: function (a) {
            ...
            this.set("drawStyle", a || {strokeColor: "#006600", ya: 0.9, fillColor: "#006600", kc: 0.9})
        }, DA: function () {
            return this.view.DA()
        }, endDraw: function () {
            this.set("draw", null)
    ...
    Gc.Yb({
        isHotspotChanged: function () {
            if ("undefined" !== typeof this.Qq && (this.oX(), this.get("isHotspot"))) {
                var a = this.get("layers", null, !0);
                a && a.length && !this.Qq && this.Nu && this.e0()
            }
        }, e0: function () {
            if (this.ti)this.CK(); else {
                var a = this;
            ...
            var a = this.ti;
            this.ti.setMap(this);
            a.e("mouseover", this.RL, this);
            a.e("click", this.PL, this);
            a.e("mouseout", this.QL, this)
        }, CZ: function () {
            var a = this.ti;
            a.F("mouseover", this.RL, this);
            a.F("click", this.PL, this);
            a.F("mouseout", this.QL, this);
            this.ti.setMap(null);
            this.ti = null
        }
    });
    var $ = {
        V: function (a, b, c, d) {
            ...
            V.a.add("AMap.event",
                "removeListener");
            a instanceof V.Tr && (0 === a.type ? V.B.F(a.em, a.wJ, a.wK, a.Me) : 1 === a.type && (a.em.rf || (a.em.rf = V.ea.rf), V.ea.F.call(a.em, a.wJ, a.wK, a.Me)))
        }, I: function (a, b) {
    ...
    var Hc = {
        V: "addDomListener",
        $V: "addDomListenerOnce",
        addListener: "addListener",
        pI: "addListenerOnce",
        UI: "clearInstanceListeners",
        Qt: "clearListeners",
        removeListener: "removeListener",
        I: "trigger"
    }, Ic;
    for (Ic in Hc)Hc.hasOwnProperty(Ic) && ($[Hc[Ic]] = $[Ic]);
    V.event = $;
    V.event.V(window, "beforeunload", V.a.send);
    var Jc = V.W.extend({
        ka: [V.ea, V.yd], D: function (a) {
            ...
            this.get("map") && this.get("map").oI(this)
    ...
    var X = Jc.extend({
        G: {
            ...
            if (!this.aB() || !V.j.ne)return !1;
            var a = this.get("map");
            return !a || "zh_cn" !== a.get("lang") || "d" === a.get("baseRender") || this.noVector ? !1 : !0
        }, jg: function (a) {
            var b = this.get("map");
            this.aB() && (this.zz() ? this.set("mapNumber", "GS(2016)710") : this.set("mapNumber", "GS(2015)2681"));
            if (this.zz())if (this.Ek = !0, V.S.Tg) {
                ...
                if ("v" <= b.get("baseRender") || this.get("watermark"))return a = new V.S.Od(this,
                    a), a.type = "\u77e2\u91cf\u5e95\u56fe", a
            } else return ["vectorlayer", "overlay"]; else return this.Ek = !1, new V.S.Yf(this, a, null, this.G.maxDataZoom)
        ...
        getTiles: function () {
            ...
            this.zz() ? (this.set("getTileUrl", a), this.um()) : this.set("getTileUrl",
                a)
        }, yp: function (a) {
            var b = this, c, d, f;
    ...
    X.BD = X.extend({
        G: {
            ...
            var b = this.get("map");
            V.j.ne && "d" !== b.get("baseRender") ? (this.Ek = !0, b = V.q.pv, V.j.ha && this.get("detectRetina") && (b = V.q.pv.replace("scl=1", "scl=2")), a = new V.S.Yf(this, a, this.yp(b), this.G.maxDataZoom)) : (this.Ek = !1, a = new V.S.Yf(this,
                a));
            return a
        }
    });
    ...
    var Kc = Jc.extend({
        G: {visible: !0, zooms: [3, 25], type: "overlay", zIndex: 5, alwaysRender: !0},
        D: function (a) {
            arguments.callee.cb.apply(this, arguments)
        },
        jg: function (a) {
    ...
    var Mc = Jc.extend({
        G: {visible: !0, zooms: [3, V.j.U ? 20 : 18], opacity: 1, type: "overlay", zIndex: 6}, D: function (a) {
            arguments.callee.cb.apply(this, arguments);
            this.CLASS_NAME = "AMap.ImageLayer";
            V.a.Za(this.CLASS_NAME, a)
        }, jg: function (a) {
            return V.S.nD ? new V.S.nD(this, a) : ["imagelayer"]
        }, getMap: function () {
            V.a.add(this.CLASS_NAME, "getMap");
            return this.Qi.map
        }, show: function () {
    ...
    var Nc = Jc.extend({
        G: {
            ...
            V.j.$q && (this.yi = !0, b.size && (b.size = V.g.uj(b.size)), this.setData(a), V.g.fb(this, b), b.style ? (this.ye(this.G, !0), this.setStyle(b.style)) : this.setStyle(this.G))
        }, clear: function () {
        ...
        setStyle: function (a) {
            ...
            if (a instanceof Array) {
                for (var b = 0; b < a.length; b += 1)a[b].size = V.g.uj(a[b].size), a.wf = Math.max(a.wf || 0, a[b].size.width + a[b].anchor.x), a.tg = Math.max(a.wf || 0, a[b].size.height + a[b].anchor.y);
                this.Lh = a
            } else a.size && (a.size = V.g.uj(a.size)), this.ye(a, !0), this.Lh = {
                anchor: this.get("anchor"),
                url: this.get("url"),
                size: this.get("size")
            }, this.Lh.wf = this.Lh.size.width + this.Lh.anchor.x, this.Lh.tg = this.Lh.size.height + this.Lh.anchor.y;
            this.w("style")
        }, setData: function (a) {
            V.a.add(this.CLASS_NAME,
                "setData");
    ...
    var Bc = Mc.extend({
        D: function (a, b, c) {
            ...
            V.a.add(this.CLASS_NAME, "setMap");
            a ? (this.get("map") && (this.get("map").yo(this), this.XI && $.removeListener(this.XI), this.hJ && $.removeListener(this.hJ)), this.set("map", a)) : this.get("map") && (this.get("map").yo(this), this.Qi.map = null)
        }, mapChanged: function () {
            this.get("map") && (this.get("map").oI(this), this.get("clickable") && (this.XI = $.addListener(this.get("map"), "click", this.X_, this), this.hJ = $.addListener(this.get("map"), "dblclick", this.Y_, this)))
        }
    });
    var Fc = V.W.extend({
        ka: [V.ea, V.yd, {ma: V.g.ma}], G: {extData: {}, bubble: !1, clickable: !0, draggable: !1}, D: function () {
            this.Ns = V.g.Bb(this)
        }, O5: function () {
            return this.Ns
        }, Z4: function () {
            ...
            this.get("map", null, !0) && this.get("map", null, !0).rI(this)
        }, show: function () {
            V.a.add(this.CLASS_NAME, "show");
            this.set("visible", !0)
        }, hide: function () {
    ...
    var Oc = Fc.extend({
        D: function (a) {
            ...
            var a = {}, b = "map zIndex strokeColor strokeOpacity strokeWeight strokeStyle strokeDasharray extData bubble clickable".split(" "), c = "isOutline outlineColor geodesic path lineJoin lineCap borderWeight showDir".split(" "),
    ...
    var Rc = V.W.extend({
        ka: [V.ea, V.yd], G: {coords: [], type: ""}, D: function (a) {
    ...
    var Z = Fc.extend({
        G: {
            ...
            this.get("map", null, !0) && (this.get("position", null, !0) || this.set("position", this.get("map").get("center")), this.get("map", null, !0).rI(this))
            ...
            a = this.ma(a);
            this.set("move", {Qe: a, speed: b, La: c})
        }, moveAlong: function (a, b, c, d) {
            V.a.add(this.CLASS_NAME, "moveAlong");
            this.set("move", {Qe: a, speed: b, La: c, fX: d})
        }, stopMove: function () {
    ...
    V.en = {
        gC: 12, i4: function (a) {
            if (V.j.ne && !V.j.U && a.position && (new Date).getHours() === V.en.gC && (V.sa || (V.sa = []), a.title || a.content)) {
                var b = {p: [a.position.M, a.position.O]};
                a.title && (b.t = a.title);
            ...
            if (V.sa && V.sa.length) {
                var a = V.en.Cq(JSON.stringify({mks: V.sa, from: V.q.IY, key: V.q.key}));
                new V.ra.XMLHttpRequest(V.q.pb + "/count", {zX: "data=" + a, Mc: "POST"});
                V.sa = []
            }
        }, Cq: function (a) {
    ...
    if (V.j.ne && !V.j.U && (new Date).getHours() === V.en.gC) {
        var Sc = setInterval(function () {
            (new Date).getHours() !== V.en.gC ? clearInterval(Sc) : V.en.jH()
        }, 6E3);
        V.event.V(window, "beforeunload", V.en.jH)
    }
    ;
    var zc = Fc.extend({
        G: {visible: !1, items: []}, D: function (a) {
            ...
            this.get("items").push({HN: a, La: b, Tu: c});
            this.w("items")
        }, removeItem: function (a, b) {
            V.a.add(this.CLASS_NAME, "removeItem");
            var c = this.get("items"), d, f;
            for (f = 0; f < c.length; f += 1)if (d = c[f], d.HN === a && d.La === b) {
                c.splice(f, 1);
                break
            }
            this.w("items")
            ...
            this.setMap(null);
            this.map && (this.map = this.map.Wt = null, this.w("close", {type: "close", target: this}))
        }
    });
    var Ac = Fc.extend({
        G: {
    ...
    var Ec = Pc.extend({
        D: function (a) {
            ...
            a.path && (a.path = this.ma(a.path));
            V.g.fb(this, V.extend({fillColor: "#FFAA00", fillOpacity: 0.9}, a));
            this.setOptions(this.G)
        }, wA: function (a) {
            ...
            if (!a.length || a[0] instanceof V.P)b = this.wA(a); else {
                b = this.wA(a[0]);
                for (var c = 1; c < a.length; c += 1)b -= this.wA(a[c])
            }
            ...
            a = [a.M, a.O];
            for (var c, d = 0, f = b.length; d < f && (c = this.VW(b[d]), V.Tc.vk(c) || c.reverse(), c = V.Tc.Dd(a, c, 0 === d ? !0 : !1), 0 < d && (c = !c), c); d += 1);
            return c
        }, VW: function (a) {
    ...
    var Cc = Oc.extend({
        G: {
            ...
            V.a.add(this.CLASS_NAME, "setCenter");
            (a = V.g.ma(a)) && a instanceof V.P && (this.set("center", a), this.w("change", {
                type: "change",
                target: this
    ...
    V.Tc = {
        jk: function (a, b) {
            for (var c = Infinity, d = 0, f = 1, g = b.length; f < g; d = f, f += 1)c = Math.min(c, V.Tc.j2(a, [b[d], b[f]]));
            return Math.sqrt(c)
        }, j2: function (a, b) {
            return this.i2(a, this.YI(a, b))
        }, i2: function (a, b) {
    ...
    Tc.plugin = Tc.service = Gc.prototype.plugin;
    Tc.TileLayer.Satellite = X.DD;
    Tc.TileLayer.RoadNet = X.BD;
    Tc.TileLayer.Traffic = X.FD;
    Tc.Panorama.Events = $;
    Tc.TileLayer.PanoramaLayer = X.O3;
    Tc.UA = {ie: V.j.bo, ielt9: V.j.nd, ielt11: V.j.GZ, mobile: V.j.U, android: V.j.Gg, ios: V.j.LK};
    Tc.User = {key: V.q.key};
    window.AMap = Tc;
    ...
    window.AMap.convertFrom = function (a, b, c) {
        ...
        d += 0 < b.length ? "?" + b.join("&") : "";
        d = new V.ra.Ca(d, {callback: "callback"});
